...
#include <kino_car_planner/car_search.h>
using namespace kino_car_planner;
...
int main(int argc, char **argv)
{
    ...
    nh_priv.param("car/mesh_resource", mesh_resource, std::string("package://kino_car_planner/param/car.dae"));
