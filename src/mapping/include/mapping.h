...
private:
    ...
    ros::Subscriber indep_cloud_sub_, indep_odom_sub_, global_cloud_sub_;
    void localcloudCallback(const sensor_msgs::PointCloud2ConstPtr& pc);
    void globalcloudCallback(const sensor_msgs::PointCloud2ConstPtr& pc);
    ...
    Eigen::Vector3d center_position_, lidarIncar_;
    ...
    std::string lidar_topic_ = "world";
    std::string global_lidar_topic_ = "world";
    std::string map_pub_topic_ = "world";
